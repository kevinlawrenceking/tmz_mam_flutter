...
class _MetadataUpdateFormWidgetState extends State<MetadataUpdateFormWidget> {
  ...
  return TextFormField(
    ...
    style: theme.bodyText1, // Use your theme's body text style here
  );
}
...
Widget buildFormCard(FlutterFlowTheme theme) {
  return Card(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          Text('Update Metadata', style: theme.title3.override(fontFamily: 'Open Sans')), // Adjust the style to match your needs
          const SizedBox(height: 10),
          buildTextField('Headline', 'Insert Text ...', theme),
          const SizedBox(height: 16), // Added space between the headline text field and the dropdown
          buildDropDown('Celebrity', ['Admin', 'Manager', 'Editor', 'Viewer'], theme),
          const SizedBox(height: 16), // Adjusted space between the dropdown and the next text field
  ...
  Widget buildDropDown(String label, List<String> options, FlutterFlowTheme theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          padding: const EdgeInsets.only(top: 16.0),
          child: Text(label, style: theme.bodyMedium.override(fontFamily: 'Roboto')), // Adjust the style to match your needs
        ),
        DropdownButtonFormField<String>(
          items: options.map((option) => DropdownMenuItem(value: option, child: Text(option))).toList(),
          decoration: InputDecoration(
            fillColor: theme.secondaryBackground, // Adjust according to FlutterFlowTheme
